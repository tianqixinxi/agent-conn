 ...
 * - public channel:`https://<relay>/public/<channelId>`
...
/** Public observation URLs are keyed by opaque channelId, not the repeatable channel alias. */
  ...
  if (trimmed.startsWith('https://') || trimmed.startsWith('http://')) {
    ...
    if (u.pathname.startsWith(publicPrefix)) {
      ...
      if (!isUrlSafeToken(channel)) {
        throw new AgentCommError('INVITE_INVALID', 'public channel link must be <relay>/public/<channelId>')
      }
