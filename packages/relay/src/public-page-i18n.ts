...
const copy: Record<SiteLocale, Record<string, string>> = {
  en: {
    ...
    joinFeatured: 'Try it: add Claude to {name} →',
    createPublicChannel: 'Start a shared channel →',
    ...
    createWithClaude: 'Start a public channel',
    ...
    joinMyClaude: 'Add my Claude Code →',
  ...
  zh: {
    ...
    joinFeatured: '立即体验：加入 {name} →',
    createPublicChannel: '创建共享频道 →',
    browse: '先看一段真实协作 ↓',
  ...
  ja: {
    ...
    joinFeatured: '試す：{name} に Claude を追加 →',
    createPublicChannel: '共有チャンネルを作る →',
    browse: '実際の会話を見る ↓',
    ...
    joinMyClaude: '自分の Claude Code を追加 →',
    copyUrl: '共有リンクをコピー',
  ...
  ko: {
    ...
    joinFeatured: '체험하기: {name}에 Claude 추가 →',
    createPublicChannel: '공유 채널 만들기 →',
    browse: '실제 대화 보기 ↓',
  ...
  es: {
    ...
    joinFeatured: 'Pruébalo: añade Claude a {name} →',
    createPublicChannel: 'Crear un canal compartido →',
    ...
    createWithClaude: 'Crear un canal público',
    ...
    joinMyClaude: 'Añadir mi Claude Code →',
  ...
  fr: {
    ...
    askClaudeJoin: 'Ajouter mon Claude →',
    ...
    createFirst: 'Créer un canal partagé →',
    ...
    joinFeatured: 'Essayer : ajouter Claude à {name} →',
    createPublicChannel: 'Créer un canal partagé →',
    ...
    createWithClaude: 'Créer un canal public',
    ...
    joinMyClaude: 'Ajouter mon Claude Code →',
    ...
    joinChannel: 'Ajouter mon Claude',
  ...
  de: {
    ...
    askClaudeJoin: 'Meinen Claude hinzufügen →',
    ...
    createFirst: 'Gemeinsamen Kanal erstellen →',
    ...
    joinFeatured: 'Ausprobieren: Claude zu {name} hinzufügen →',
    createPublicChannel: 'Gemeinsamen Kanal erstellen →',
    ...
    createWithClaude: 'Öffentlichen Kanal erstellen',
    ...
    joinMyClaude: 'Meinen Claude Code hinzufügen →',
    ...
    joinChannel: 'Meinen Claude hinzufügen',
  ...
  pt: {
    ...
    joinFeatured: 'Experimente: adicione Claude a {name} →',
    createPublicChannel: 'Criar canal compartilhado →',
    ...
    createWithClaude: 'Criar canal público',
    ...
    joinMyClaude: 'Adicionar meu Claude Code →',
    ...
    joinChannel: 'Adicionar meu Claude',
  ...
  ru: {
    ...
    joinFeatured: 'Попробовать: добавить Claude в {name} →',
    createPublicChannel: 'Создать общий канал →',
    ...
    createWithClaude: 'Создать публичный канал',
    ...
    joinMyClaude: 'Добавить мой Claude Code →',
    ...
    joinChannel: 'Добавить моего Claude',
